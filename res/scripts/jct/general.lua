...
general.linkingLane = function(f, t) return ((t - f):length2() > 1e-2 and (t - f):length2() < 562500) and general.newModel("jct/linking_lane.mdl", general.mRot(t - f), coor.trans(f)) or nil end
general.unitLane = function(f, t) return ((t - f):length2() > 1e-2 and (t - f):length2() < 562500) and general.newModel("jct/person_lane.mdl", general.mRot(t - f), coor.trans(f)) or nil end
